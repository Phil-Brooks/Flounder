...
[<IsByRefLike; Struct>]
type OrderedMoveList(memory:Span<OrderedMoveEntry>, ply:int, killerMoveTable:KillerMoveTable, historyTable:HistoryTable) =
    ...
    member _.PRIORITY = Int32.MaxValue
    static member MvvLvaTable =
        [|
